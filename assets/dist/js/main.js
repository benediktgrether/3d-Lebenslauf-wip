...
var clickCardArrow = function clickCardArrow(getI, getJ) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__showText__["a" /* default */])(".card-text", i, j, 0, 100);
};
...
var clickCardClose = function clickCardClose() {
    ...
    setTimeout(function () {
        Object(__WEBPACK_IMPORTED_MODULE_2__renderInit__["a" /* newPositionSmoke */])(false);
    }, 500);
};
...
var clickUiInformation = function clickUiInformation() {
    $('.ui-information-wrapper').on('click', function () {
        ...
        setTimeout(function () {
            Object(__WEBPACK_IMPORTED_MODULE_1__showText__["a" /* default */])(".card-text", 1, 0, 0, 100);
        }, 700);
    });
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return renderInit; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return showInformation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return smoke; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__smoke__ = __webpack_require__(11);
/* unused harmony reexport startingSmokeAnimation */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__smoke__["a"]; });
...
$(document).ready(function () {
    ...
    // }); 
    Object(__WEBPACK_IMPORTED_MODULE_2__renderInit__["b" /* renderInit */])();
});
...
/* harmony default export */ __webpack_exports__["a"] = (showText);
...
function startingSmokeAnimation(objectByName, renderSmoke) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].scale.x > 0) {
        if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].position.y > 0.4 && charVisibility == false && showModel == true) {
            objectByName.visible = true;
            charVisibility = true;
            setTimeout(function () {
                Object(__WEBPACK_IMPORTED_MODULE_0__renderInit__["c" /* showInformation */])();
            }, 5000);
        } else if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].position.y > 0.4 && charVisibility == true && showModel == false) {
            objectByName.visible = false;
            charVisibility = false;
        }
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].position.y += Math.sin(1) * 0.015;
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].scale.x -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].scale.y -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].scale.z -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
    } else {
        // showInformation();
        renderSmoke = false;
        return renderSmoke;
    }
    if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].scale.x > 0) {
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].position.y += Math.sin(1) * 0.016;
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].scale.x -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].scale.y -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].scale.z -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
    }
    if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].scale.x > 0) {
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].position.y += Math.sin(1) * 0.017;
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].scale.x -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].scale.y -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].scale.z -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
    }
    if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].scale.x > 0) {
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].position.y += Math.sin(1) * 0.018;
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].scale.x -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].scale.y -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].scale.z -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
    }
    if (__WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].scale.x > 0) {
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].position.y += Math.sin(1) * 0.019;
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].scale.x -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].scale.y -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].scale.z -= (Math.sin(1) * 0.001, Math.sin(1) * 0.001, Math.sin(1) * 0.001);
        // }
    }
}
...
function newPositionSmoke(getShowModel) {
    showModel = getShowModel;
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].position.set(0.8, -2.5 + 1.5, -0.8);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].position.set(0.8, -2.5 + 1.7, -1);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].position.set(0.8, -2.5 + 1.8, -0.5);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].position.set(0.8, -2.5 + 2, -0.8);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].position.set(0.7, -2.5 + 2.2, -0.9);

    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][0].scale.set(0.5, 0.5, 0.5);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][1].scale.set(0.45, 0.45, 0.45);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][2].scale.set(0.3, 0.3, 0.3);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][3].scale.set(0.25, 0.25, 0.25);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* smoke */][4].scale.set(0.2, 0.2, 0.2);
