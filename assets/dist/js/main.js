...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d"]; });
...
function renderInit() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2__objectLoad__["e" /* objectLoad */])();
    //#endregion
    ...
    var animate = function animate() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__main__["nav"] == false) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_0__main__["cv"] == true) {
                ...
                camera.lookAt(__WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position);
                spotLight.position.set(3 + __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.x, 14, 12 + __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.z);
                spotLight.target.position.set(__WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.x, __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.y, __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.z);
...
function charMovement(delta) {
    ...
    if (keyboard[87] || keyboard[38] || keyboard[83] || keyboard[40] || keyboard[37] || keyboard[39]) {
        ...
        if (keyboard[37]) {
            __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].rotation.y += Math.PI * 0.01;
        }
        if (keyboard[39]) {
            __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].rotation.y -= Math.PI * 0.01;
        }
        // console.log(camera.translateX)
        __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].translateX(playerVelocity.x * delta);
        __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].translateZ(playerVelocity.z * delta);

        // #region Camera
        camera.position.x = 20 + __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.x;
        camera.position.z = 20 + __WEBPACK_IMPORTED_MODULE_2__objectLoad__["d" /* objectByName */].position.z;
        camera.updateProjectionMatrix();
    } else {
...
function initTween(getI) {
    ...
    tween.onComplete(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1__objectLoad__["c" /* meshes */]["charHolo"].position.x = __WEBPACK_IMPORTED_MODULE_3__renderInit__["b" /* objectByName */].position.x;
        tweenUpdate = false;
        i++;
        setTimeout(function () {
...
function lunarLandingAnimation() {
    console.log(__WEBPACK_IMPORTED_MODULE_1__objectLoad__["c" /* meshes */]["lunar"].position);
    var position = { y: __WEBPACK_IMPORTED_MODULE_1__objectLoad__["c" /* meshes */]["lunar"].position.y };
    var target = { y: 0.94 };
    console.log(position, target);
    tween = new TWEEN.Tween(position).to(target, 10000);
    tween.onUpdate(function () {
        __WEBPACK_IMPORTED_MODULE_1__objectLoad__["c" /* meshes */]["lunar"].position.y = position.y;
    });
    ...
    tween.onComplete(function () {
        console.log('done!');
        tweenUpdate = false;
        if (__WEBPACK_IMPORTED_MODULE_4__main__["cv"] == false) {
            setTimeout(function () {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return objectLoad; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return objectByName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return meshes; });
...
function loadCV() {
    ...
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* scene */].add(meshes["track06"]);
    __WEBPACK_IMPORTED_MODULE_0__renderInit__["d" /* scene */].add(meshes["track07"]);
...
function showHolo(getHide) {
    ...
    if (checkHideForMovement == false) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__objectLoad__["c" /* meshes */]["charHolo"].visible = true;
        counter++;
        setTimeout(function () {
            hideHolo();
        }, timing);
...
function hideHolo() {
    if (counter <= 10) {
        console.log("test");
        __WEBPACK_IMPORTED_MODULE_2__objectLoad__["c" /* meshes */]["charHolo"].visible = false;
        setTimeout(function () {
            showHolo(false);
        }, timing);
        timing = timing / 2;
        console.log(timing);
        if (counter == 5) {
            __WEBPACK_IMPORTED_MODULE_2__objectLoad__["c" /* meshes */]["char"].visible = true;
        }
    } else {
...
function hideHoloForMovement() {
    ...
    if (counter <= 10) {
        ...
        console.log(timing);
        if (counter == 2) {
            __WEBPACK_IMPORTED_MODULE_2__objectLoad__["c" /* meshes */]["char"].visible = false;
        }
    } else {
        counter = 0;
        timing = 500;
